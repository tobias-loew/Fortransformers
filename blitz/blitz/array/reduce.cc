...
template<typename Array, typename T_reduction>
_bz_typename T_reduction::T_resulttype
_bz_ArrayExprFullReduce_tv(Array const& array, T_reduction reduction)
{
    return _bz_reduceWithIndexTraversal(array, reduction);
}

template<typename Array, typename T_reduction>
_bz_typename T_reduction::T_resulttype
_bz_ArrayExprFullReduce_tbv(Array const& array, T_reduction reduction)
{
    return _bz_reduceWithIndexTraversal(array, reduction);
}
...
template<typename Array, typename T_reduction>
_bz_typename T_reduction::T_resulttype
_bz_ArrayExprFullReduce_StaticFortranArrayPolicy(Array const& array, T_reduction reduction)
{
    return _bz_reduceWithIndexTraversal(array, reduction);
}
...
_bz_typename T_reduction::T_resulttype
_bz_reduceWithIndexTraversalGeneric(T_expr const& expr, T_reduction reduction)
{
