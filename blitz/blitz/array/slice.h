...
public:
    static constexpr int isValidType = 0, rank = 0, isPick = 0;
};

template<>
class ArraySectionInfo<Range> {
public:
    static constexpr int isValidType = 1, rank = 1, isPick = 0;
};

template<>
class ArraySectionInfo<int> {
public:
    static constexpr int isValidType = 1, rank = 0, isPick = 0;
};
...
template<typename T_numtype, typename Policy, typename T1, typename T2 = nilArraySection,
...
class SliceInfo {
//    static_assert(is_policy_type<Policy>::value, "not a policy type");
public:
    ...
    typedef Array<T_numtype,numValidTypes, Policy> T_array;
    typedef Array<T_numtype,rank, Policy> T_slice;
};
