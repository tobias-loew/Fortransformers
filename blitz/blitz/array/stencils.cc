...
template<typename Policy, int N_rank, typename T_numtype1, typename T_array2,
    class T_array3, typename T_array4, typename T_array5, typename T_array6,
    class T_array7, typename T_array8, typename T_array9, typename T_array10,
    class T_array11>
void checkShapes(const Array<T_numtype1,N_rank, Policy>& BZ_DEBUG_PARAM(A),
...
template<typename Policy, int N_rank, typename T_stencil, typename T_numtype1, typename T_array2>
RectDomain<N_rank> interiorDomain(const T_stencil& stencil,
    const Array<T_numtype1,N_rank, Policy>& A,
    const T_array2& B)
{
...
template<typename Policy, int N_rank,
    class T_stencil, typename T_numtype1, typename T_array2,
    class T_array3, typename T_array4, typename T_array5, typename T_array6,
    class T_array7, typename T_array8, typename T_array9, typename T_array10,
    class T_array11>
static void getStencilExtent(TinyVector<int,N_rank>& minb,
    ...
    const T_stencil& stencil, Array<T_numtype1,N_rank, Policy>& A,
...
static inline void getStencilExtent(TinyVector<int,N_rank>& minb,
    TinyVector<int,N_rank>& maxb,
    const T_stencil& stencil, Array<T_numtype1,N_rank, Policy>&,
 ...
 */
template<typename T_stencil, typename Policy, typename T_numtype1, typename T_array2,
    class T_array3, typename T_array4, typename T_array5, typename T_array6,
    class T_array7, typename T_array8, typename T_array9, typename T_array10,
    class T_array11>
void applyStencil_imp(const T_stencil& stencil, Array<T_numtype1,3, Policy>& A,
    T_array2& B, T_array3& C, T_array4& D, T_array5& E, T_array6& F,
    T_array7& G, T_array8& H, T_array9& I, T_array10& J, T_array11& K)
{
...
template<typename T_stencil, typename Policy, typename T_numtype1, typename T_array2,
    ...
    class T_array7, typename T_array8, typename T_array9, typename T_array10,
    class T_array11>
void applyStencil_imp(const T_stencil& stencil, Array<T_numtype1,2, Policy>& A,
    T_array2& B, T_array3& C, T_array4& D, T_array5& E, T_array6& F, 
    T_array7& G, T_array8& H, T_array9& I, T_array10& J, T_array11& K)
{
    checkShapes(A,B,C,D,E,F,G,H,I,J,K);
...
template<typename T_stencil, typename Policy, typename T_numtype1, typename T_array2,
    ...
    class T_array7, typename T_array8, typename T_array9, typename T_array10,
    class T_array11>
void applyStencil_imp(const T_stencil& stencil, Array<T_numtype1,1, Policy>& A,
    T_array2& B, T_array3& C, T_array4& D, T_array5& E, T_array6& F, 
    T_array7& G, T_array8& H, T_array9& I, T_array10& J, T_array11& K)
{
    checkShapes(A,B,C,D,E,F,G,H,I,J,K);
 ...
 */
template<typename T_stencil, typename T_numtype1, int N_rank, typename Policy>
inline void applyStencil(const T_stencil& stencil, Array<T_numtype1,N_rank, Policy>& A)
{
...
template<typename T_stencil, typename T_numtype1, int N_rank, typename Policy, typename T_array2>
inline void applyStencil(const T_stencil& stencil, Array<T_numtype1,N_rank, Policy>& A,
    T_array2& B)
{
