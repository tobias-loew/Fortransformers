/***************************************************************************
 * blitz/array/interlace.cc   Interlaced array storage.
 *
 * $Id$
 *
...
void makeInterlacedArray(Array<T_numtype,2, Policy>& mainArray,
    Array<T_numtype,1, Policy>& subarray, int slice)
{
    Array<T_numtype,1, Policy> tmp = mainArray(Range::all(), slice);
    subarray.reference(tmp);
}

template<typename T_numtype, typename Policy>
void makeInterlacedArray(Array<T_numtype,3, Policy>& mainArray,
    Array<T_numtype,2, Policy>& subarray, int slice)
{
    Array<T_numtype,2, Policy> tmp = mainArray(Range::all(), Range::all(),
        slice);
    subarray.reference(tmp);
}

template<typename T_numtype, typename Policy>
void makeInterlacedArray(Array<T_numtype,4, Policy>& mainArray,
    Array<T_numtype,3, Policy>& subarray, int slice)
{
    Array<T_numtype,3, Policy> tmp = mainArray(Range::all(), Range::all(),
        Range::all(), slice);
    subarray.reference(tmp);
}
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    Array<T_numtype,N_rank, Policy>& a1, Array<T_numtype,N_rank, Policy>& a2)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    Array<T_numtype,N_rank, Policy>& a1, Array<T_numtype,N_rank, Policy>& a2,
    Array<T_numtype,N_rank, Policy>& a3)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    Array<T_numtype,N_rank, Policy>& a1, Array<T_numtype,N_rank, Policy>& a2,
    Array<T_numtype,N_rank, Policy>& a3, Array<T_numtype,N_rank, Policy>& a4)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    Array<T_numtype,N_rank, Policy>& a1, Array<T_numtype,N_rank, Policy>& a2,
    Array<T_numtype,N_rank, Policy>& a3, Array<T_numtype,N_rank, Policy>& a4,
    Array<T_numtype,N_rank, Policy>& a5)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    Array<T_numtype,N_rank, Policy>& a1, Array<T_numtype,N_rank, Policy>& a2,
    Array<T_numtype,N_rank, Policy>& a3, Array<T_numtype,N_rank, Policy>& a4,
    Array<T_numtype,N_rank, Policy>& a5, Array<T_numtype,N_rank, Policy>& a6)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    ...
    Array<T_numtype,N_rank, Policy>& a3, Array<T_numtype,N_rank, Policy>& a4,
    Array<T_numtype,N_rank, Policy>& a5, Array<T_numtype,N_rank, Policy>& a6,
    Array<T_numtype,N_rank, Policy>& a7)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    ...
    Array<T_numtype,N_rank, Policy>& a3, Array<T_numtype,N_rank, Policy>& a4,
    Array<T_numtype,N_rank, Policy>& a5, Array<T_numtype,N_rank, Policy>& a6,
    Array<T_numtype,N_rank, Policy>& a7, Array<T_numtype,N_rank, Policy>& a8)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    ...
    Array<T_numtype,N_rank, Policy>& a5, Array<T_numtype,N_rank, Policy>& a6,
    Array<T_numtype,N_rank, Policy>& a7, Array<T_numtype,N_rank, Policy>& a8,
    Array<T_numtype,N_rank, Policy>& a9)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    ...
    Array<T_numtype,N_rank, Policy>& a5, Array<T_numtype,N_rank, Policy>& a6,
    Array<T_numtype,N_rank, Policy>& a7, Array<T_numtype,N_rank, Policy>& a8,
    Array<T_numtype,N_rank, Policy>& a9, Array<T_numtype,N_rank, Policy>& a10)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
void interlaceArrays(const TinyVector<int,N_rank>& shape,
    ...
    Array<T_numtype,N_rank, Policy>& a7, Array<T_numtype,N_rank, Policy>& a8,
    Array<T_numtype,N_rank, Policy>& a9, Array<T_numtype,N_rank, Policy>& a10,
    Array<T_numtype,N_rank, Policy>& a11)
{
    GeneralArrayStorage<N_rank+1> storage(contiguousData);
...
template<typename T_numtype, int N_rank, typename Policy>
Array<T_numtype,N_rank, Policy>::Array(const TinyVector<int,N_rank-1>& shape,
...
#if 0
template<typename T_numtype, int N_rank, typename Policy>
Array<T_numtype,N_rank, Policy>::Array(const TinyVector<Range,N_rank-1>& shape,
    int lastExtent, const GeneralArrayStorage<N_rank>& storage)
    : storage_(storage)
{
#ifdef BZ_DEBUG
