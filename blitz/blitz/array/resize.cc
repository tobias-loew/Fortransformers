...
void Array<T_numtype, N_rank, Policy>::resize(int extent0)
{
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resize(int extent0, int extent1)
{
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resize(Range r0)
{
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resize(Range r0, Range r1)
{
	BZPRECONDITION(r0.isAscendingContiguous() &&
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resize(Range r0, Range r1, Range r2)
{ 
	BZPRECONDITION(r0.isAscendingContiguous() &&
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resizeAndPreserve(int length0)
{
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resizeAndPreserve(int length0, int length1)
{
...
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resize(const TinyVector<int,N_rank>& extent)
{
...
/* Added by Julian Cummings */
template<typename T_numtype, int N_rank, typename Policy>
void Array<T_numtype, N_rank, Policy>::resizeAndPreserve(
