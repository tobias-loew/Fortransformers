...
inline Array<T_numtype, N_rank, Policy> real(const Array<complex<T_numtype>,N_rank, Policy>& A)
{
    return A.extractComponent(T_numtype(), 0, 2);
}

template<typename T_numtype, int N_rank, typename Policy>
inline Array<T_numtype, N_rank, Policy> imag(const Array<complex<T_numtype>,N_rank, Policy>& A)
{
