...
public:
  ...
  static constexpr int digits   = __Digits;
  static constexpr int digits10 = __Digits10;

  static const bool is_signed = true;

  static constexpr int radix = 2;

  static constexpr int min_exponent   = __MinExp;
  static constexpr int max_exponent   = __MaxExp;
  static constexpr int min_exponent10 = __MinExp10;
  static constexpr int max_exponent10 = __MaxExp10;
