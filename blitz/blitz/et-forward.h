...
template<typename P_numtype, int N_rank, typename Policy> class Array;
...
template<typename P_numtype, int N_length, int N_base> class TinyBasedVector;
template<typename P_numtype, int N_rows, int N_columns, int N_rows_base, int N_columns_base, bool B_column_major>
class TinyBasedMatrix;

// and their fast iterators
template<typename P_numtype, int N_rank, typename Policy> class FastArrayIterator;
...
template<typename P_numtype, int N_length, int N_base> class FastTBV2Iterator;
