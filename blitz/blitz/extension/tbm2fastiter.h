 ...
 *
 ****************************************************************************/
#ifndef BZ_ARRAY_TBM2FASTITER_H
#define BZ_ARRAY_TBM2FASTITER_H
...
template<typename P_numtype, int N_rows, int N_columns, int N_rows_base, int N_columns_base, bool B_column_major, typename P_arraytype>
class FastTBM2IteratorBase {
public:
  ...
  typedef FastTBM2IteratorBase<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major, P_arraytype> T_iterator;
  ...
  FastTBM2IteratorBase(const T_iterator& x)
    ...
    FastTBM2IteratorBase(const T_matrix& array)
        : array_(array)
    {
        data_   = array_.data();
    }

    ~FastTBM2IteratorBase()
    { }
  ...
  static diffType suggestStride(int r)
  ...
  static constexpr bool isUnitStride(int r)
...
template<typename P_numtype, int N_rows, int N_columns, int N_rows_base, int N_columns_base, bool B_column_major>
class FastTBM2Iterator : 
  public FastTBM2IteratorBase<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major,
			     const TinyBasedMatrix<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major>&>
{
public:
  typedef FastTBM2IteratorBase<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major,
			      const TinyBasedMatrix<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major>&> T_base;
  ...
  FastTBM2Iterator(const FastTBM2Iterator& x) 
    : T_base(x)
  { }

  FastTBM2Iterator(const T_matrix& array) : T_base(array) {}
  
  using T_base::operator=;
  void operator=(const FastTBM2Iterator<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major>& x)
  {
    T_base::operator=(x);
  }
  ...
  // FastTBM2CopyIterator<T_numtype, T_base::template SliceInfo<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>::T_slice::rank>
  // operator()(T1 r1, T2 r2, T3 r3, T4 r4, T5 r5, T6 r6, T7 r7, T8 r8, T9 r9, T10 r10, T11 r11) const
  // {
  //   typedef FastTBM2CopyIterator<T_numtype, T_base::template SliceInfo<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>::T_slice::rank> slice;
...
/* This version of the FastTBM2Iterator makes a COPY of the array
...
template<typename P_numtype, int N_rows, int N_columns, int N_rows_base, int N_columns_base, bool B_column_major >
class FastTBM2CopyIterator : 
  public FastTBM2IteratorBase<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major, const TinyBasedMatrix<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major> >
{
public:
  typedef FastTBM2IteratorBase<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major,
			      const TinyBasedMatrix<P_numtype, N_rows, N_columns, N_rows_base, N_columns_base, B_column_major> > T_base;
  ...
  // NB: this ctor does NOT preserve stack and stride
  // parameters.  This is for speed purposes.
  FastTBM2CopyIterator(const FastTBM2CopyIterator& x) 
    : T_base(x)
  { }

  FastTBM2CopyIterator(const T_matrix& array) : T_base(array) { }
  
  using T_base::operator=;
  void operator=(const FastTBM2CopyIterator& x)
  {
    T_base::operator=(x);
  }
