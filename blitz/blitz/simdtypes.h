...
public:
  ...
  static inline bool isVectorAligned(const T* _bz_restrict pointer)
  ...
  static inline diffType offsetToAlignment(const T* _bz_restrict pointer) { 
...
template <typename T>
inline bool isVectorAligned(const T* _bz_restrict pointer) {
